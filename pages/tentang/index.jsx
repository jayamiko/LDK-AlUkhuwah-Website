...
const About = () => {
  return (
    <>
      ...
      >
        <Header />
        <div className="h-3/5 w-full flex items-end justify-end pb-[10vh]">
          <Title title="Tentang LDK" />
        </div>
      </section>
      <main className="relative z-40 container mx-auto my-5 text-sky-800 px-4 sm:px-0">
        <h1 className="text-xl md:text-2xl lg:text-4xl font-titan m-0">
          Tentang UKM {alUkhuwah}
        </h1>
        ...
        <div className="flex h-full flex-col justify-center">
          <article>
              ...
              >
                ...
                {visiMisi.map((list) => {
                  return (
                    <>
                      <p>{list.visi}</p>
                      <h2 className="font-bold text-base sm:text-lg lg:text-xl m-0">
                        Misi
                      </h2>
                  ...
                  {OrganizationValue.map((value, index) => {
                    return (
                      <li key={index} id={value.id}>
                        ...
                        <p className="indent-6">{value.paragraph}</p>
                      </li>
                    );
                  })}
                </ul>
            ...
            <>
              ...
              <div id="material-5" className="text-black text-base">
                <ul className="list-decimal list-outside pl-4">
